...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        //NavigateControllerOnAppLaunch()
        guard let _ = (scene as? UIWindowScene) else { return }
    }
    
    func NavigateControllerOnAppLaunch() {
        ...
        let savedAccountId = UserDefaults.standard.value(forKey: "accountID") as? String ?? ""
        loadUserDataFromUserDefaults()
        var userAuthData = DataStore.shared.userAuth
        ...
        if userAuthData != nil {
            ...
            DataStore.shared.accountId = savedAccountId
    ...
    func loadUserDataFromUserDefaults() {
        if let savedData = UserDefaults.standard.data(forKey: "UserAuthData") {
            ...
            do {
                ...
                print("❌ Failed to decode UserAuthData:", error)
            }
        }
    }
